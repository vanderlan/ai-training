...
export const ANALYSIS_PROMPT = `Analyze this code for migration from {source} to {target}.
...
export const PLANNING_PROMPT = `Create a migration plan based on this analysis.
...
export const MIGRATION_PROMPT = `Migrate this code from {source} to {target}.
...
export const VERIFICATION_PROMPT = `Verify this migrated code is correct.
