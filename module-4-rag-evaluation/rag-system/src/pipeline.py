...
class CodebaseRAG:
    ...
    def index_directory(
        ...
        for root, dirs, files in os.walk(directory):
            ...
            SPECIAL_FILENAMES = {'Dockerfile', 'Makefile', 'Rakefile', 'Gemfile', '.gitignore', '.env.example'}

            for file in files:
                if any(file.endswith(ext) for ext in extensions) or file in SPECIAL_FILENAMES:
