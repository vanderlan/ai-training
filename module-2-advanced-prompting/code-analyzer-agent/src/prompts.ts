/**
 * System prompts for Code Analyzer Agent
 */
...
export const SECURITY_FOCUS_PROMPT = `Focus specifically on security vulnerabilities:
- SQL injection
- Command injection
- Path traversal
- Hardcoded secrets
...
export const PERFORMANCE_FOCUS_PROMPT = `Focus specifically on performance:
